...
public class AllTypes extends org.jsii.JsiiObject {
    ...
    public org.jsii.tests.calculator.StringEnum enumMethod(final org.jsii.tests.calculator.StringEnum value) {
        return this.jsiiCall("enumMethod", org.jsii.tests.calculator.StringEnum.class, java.util.stream.Stream.of(java.util.Objects.requireNonNull(value, "value is required")).toArray());
    }
