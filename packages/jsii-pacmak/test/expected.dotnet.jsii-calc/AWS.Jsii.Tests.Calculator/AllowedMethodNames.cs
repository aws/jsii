...
namespace AWS.Jsii.Tests.Calculator
{
    ...
    public class AllowedMethodNames : DeputyBase
    {
        ...
        {
            return InvokeMethod<string>(new object[]{withParam});
        }
        ...
        {
            InvokeVoidMethod(new object[]{_p1, _p2});
        }
        ...
        {
            InvokeVoidMethod(new object[]{_x, _y});
        }
        ...
        {
            InvokeVoidMethod(new object[]{_x, _y, _z});
        }
    }
}