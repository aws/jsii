...
@jsii.data_type(jsii_type="jsii-calc.StructWithCollections", jsii_struct_bases=[], name_mapping={'array': 'array', 'map': 'map'})
class StructWithCollections():
    def __init__(self, *, array: typing.Optional[typing.List[str]]=None, map: typing.Optional[typing.Mapping[str,str]]=None):
        """
        :param array: 
        :param map: 
        ...
        if array is not None: self._values["array"] = array
        if map is not None: self._values["map"] = map

    @property
    def array(self) -> typing.Optional[typing.List[str]]:
        """
        stability
        :stability: experimental
        """
        return self._values.get('array')

    @property
    def map(self) -> typing.Optional[typing.Mapping[str,str]]:
        """
        stability
        :stability: experimental
        """
        return self._values.get('map')
    ...
    def __repr__(self) -> str:
        return 'StructWithCollections(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())
