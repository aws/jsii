...
namespace Amazon.JSII.Tests.CalculatorNamespace
{
    ...
    [JsiiClass(typeof(NullShouldBeTreatedAsUndefined), "jsii-calc.NullShouldBeTreatedAsUndefined", "[{\"name\":\"_param1\",\"type\":{\"primitive\":\"string\"}},{\"name\":\"optional\",\"type\":{\"primitive\":\"any\"}}]")]
    public class NullShouldBeTreatedAsUndefined : DeputyBase
    {
        ...
        [JsiiMethod(name: "giveMeUndefined", returnsJson: null, parametersJson: "[{\"name\":\"value\",\"type\":{\"primitive\":\"any\"}}]")]
        public virtual void GiveMeUndefined(object value)
        {
            InvokeInstanceVoidMethod(new object[]{value});
        }

        [JsiiMethod(name: "giveMeUndefinedInsideAnObject", returnsJson: null, parametersJson: "[{\"name\":\"input\",\"type\":{\"fqn\":\"jsii-calc.NullShouldBeTreatedAsUndefinedData\"}}]")]
        ...
        [JsiiMethod(name: "verifyPropertyIsUndefined", returnsJson: null, parametersJson: "[]")]
