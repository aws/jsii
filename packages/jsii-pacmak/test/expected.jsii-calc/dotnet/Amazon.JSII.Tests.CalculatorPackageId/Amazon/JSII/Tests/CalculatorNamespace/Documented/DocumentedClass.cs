...
namespace Amazon.JSII.Tests.CalculatorNamespace.Documented
{
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(Amazon.JSII.Tests.CalculatorNamespace.Documented.DocumentedClass), fullyQualifiedName: "jsii-calc.documented.DocumentedClass")]
    public class DocumentedClass : DeputyBase
    {
        ...
        /// <strong>Stability</strong>: Stable
        /// </remarks>
        [JsiiMethod(name: "greet", returnsJson: "{\"type\":{\"primitive\":\"number\"}}", parametersJson: "[{\"docs\":{\"summary\":\"The person to be greeted.\"},\"name\":\"greetee\",\"optional\":true,\"type\":{\"fqn\":\"jsii-calc.documented.Greetee\"}}]")]
        public virtual double Greet(Amazon.JSII.Tests.CalculatorNamespace.Documented.IGreetee? greetee = null)
        {
            return InvokeInstanceMethod<double>(new System.Type[]{typeof(Amazon.JSII.Tests.CalculatorNamespace.Documented.IGreetee)}, new object?[]{greetee});
        }
