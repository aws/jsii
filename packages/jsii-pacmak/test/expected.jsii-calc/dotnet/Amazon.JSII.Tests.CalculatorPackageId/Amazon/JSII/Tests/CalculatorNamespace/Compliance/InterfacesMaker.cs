...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.InterfacesMaker), fullyQualifiedName: "jsii-calc.compliance.InterfacesMaker")]
    public class InterfacesMaker : DeputyBase
    {
        ...
        {
            return InvokeStaticMethod<Amazon.JSII.Tests.CalculatorNamespace.LibNamespace.IDoublable[]>(typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.InterfacesMaker), new System.Type[]{typeof(double)}, new object[]{count});
        }
    }
}
