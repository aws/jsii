...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    /// </remarks>
    [JsiiTypeProxy(nativeType: typeof(IStructParameterType), fullyQualifiedName: "jsii-calc.compliance.StructParameterType")]
    internal sealed class StructParameterTypeProxy : DeputyBase, Amazon.JSII.Tests.CalculatorNamespace.Compliance.IStructParameterType
    {
