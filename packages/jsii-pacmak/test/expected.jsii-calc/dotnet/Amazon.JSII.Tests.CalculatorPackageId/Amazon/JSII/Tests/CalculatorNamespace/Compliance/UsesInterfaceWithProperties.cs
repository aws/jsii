...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    public class UsesInterfaceWithProperties : DeputyBase
    {
        ...
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        public UsesInterfaceWithProperties(Amazon.JSII.Tests.CalculatorNamespace.Compliance.IInterfaceWithProperties obj): base(new DeputyProps(new object[]{obj}))
        {
        }
        ...
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        [JsiiMethod(name: "readStringAndNumber", returnsJson: "{\"type\":{\"primitive\":\"string\"}}", parametersJson: "[{\"name\":\"ext\",\"type\":{\"fqn\":\"jsii-calc.compliance.IInterfaceWithPropertiesExtension\"}}]")]
        public virtual string ReadStringAndNumber(Amazon.JSII.Tests.CalculatorNamespace.Compliance.IInterfaceWithPropertiesExtension ext)
        {
            return InvokeInstanceMethod<string>(new System.Type[]{typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.IInterfaceWithPropertiesExtension)}, new object[]{ext});
        }
        ...
        public virtual Amazon.JSII.Tests.CalculatorNamespace.Compliance.IInterfaceWithProperties Obj
        {
            get => GetInstanceProperty<Amazon.JSII.Tests.CalculatorNamespace.Compliance.IInterfaceWithProperties>();
        }
    }
}
