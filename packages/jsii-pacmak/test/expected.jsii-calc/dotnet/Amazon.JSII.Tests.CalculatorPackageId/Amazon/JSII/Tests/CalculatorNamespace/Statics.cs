...
{
    [JsiiClass(typeof(Statics), "jsii-calc.Statics", "[{\"name\":\"value\",\"value\":{\"type\":{\"primitive\":\"string\"}}}]")]
    public class Statics : DeputyBase
    {
        ...
        [JsiiProperty("BAR", "{\"type\":{\"primitive\":\"number\"}}")]
        ...
        [JsiiProperty("ConstObj", "{\"type\":{\"fqn\":\"jsii-calc.DoubleTrouble\"}}")]
        ...
        [JsiiProperty("Foo", "{\"type\":{\"primitive\":\"string\"}}")]
        ...
        [JsiiProperty("zooBar", "{\"type\":{\"collection\":{\"kind\":\"map\",\"elementtype\":{\"type\":{\"primitive\":\"string\"}}}}}")]
        ...
        [JsiiProperty("instance", "{\"type\":{\"fqn\":\"jsii-calc.Statics\"}}")]
        ...
        [JsiiProperty("nonConstStatic", "{\"type\":{\"primitive\":\"number\"}}")]
        ...
        [JsiiMethod("staticMethod", "{\"type\":{\"primitive\":\"string\"}}", "[{\"name\":\"name\",\"value\":{\"type\":{\"primitive\":\"string\"}}}]")]
        public static string StaticMethod(string name)
        {
            return InvokeStaticMethod<string>(typeof(Statics), new object[]{name});
        }

        [JsiiMethod("justMethod", "{\"type\":{\"primitive\":\"string\"}}", "[]")]
