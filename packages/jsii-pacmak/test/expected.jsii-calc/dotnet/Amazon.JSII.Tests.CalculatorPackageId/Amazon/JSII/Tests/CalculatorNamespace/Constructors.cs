...
namespace Amazon.JSII.Tests.CalculatorNamespace
{
    ...
    public class Constructors : DeputyBase
    {
        ...
        [JsiiMethod("hiddenInterface", "{\"type\":{\"fqn\":\"jsii-calc.IPublicInterface\"}}", "[]")]
        ...
        [JsiiMethod("hiddenInterfaces", "{\"type\":{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"type\":{\"fqn\":\"jsii-calc.IPublicInterface\"}}}}}", "[]")]
        public static IIPublicInterface[] HiddenInterfaces()
        {
            return InvokeStaticMethod<IIPublicInterface[]>(typeof(Constructors), new object[]{});
        }

        [JsiiMethod("hiddenSubInterfaces", "{\"type\":{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"type\":{\"fqn\":\"jsii-calc.IPublicInterface\"}}}}}", "[]")]
        public static IIPublicInterface[] HiddenSubInterfaces()
        {
            return InvokeStaticMethod<IIPublicInterface[]>(typeof(Constructors), new object[]{});
        }

        [JsiiMethod("makeClass", "{\"type\":{\"fqn\":\"jsii-calc.PublicClass\"}}", "[]")]
        public static PublicClass MakeClass()
        {
            return InvokeStaticMethod<PublicClass>(typeof(Constructors), new object[]{});
        }

        [JsiiMethod("makeInterface", "{\"type\":{\"fqn\":\"jsii-calc.IPublicInterface\"}}", "[]")]
        public static IIPublicInterface MakeInterface()
        {
            return InvokeStaticMethod<IIPublicInterface>(typeof(Constructors), new object[]{});
        }

        [JsiiMethod("makeInterface2", "{\"type\":{\"fqn\":\"jsii-calc.IPublicInterface2\"}}", "[]")]
        ...
        [JsiiMethod("makeInterfaces", "{\"type\":{\"collection\":{\"kind\":\"array\",\"elementtype\":{\"type\":{\"fqn\":\"jsii-calc.IPublicInterface\"}}}}}", "[]")]
