...
namespace Amazon.JSII.Tests.CalculatorNamespace
{
    ...
    public class VariadicMethod : DeputyBase
    {
        ...
        /// <param name = "first">summary: the first element of the array to be returned (after the `prefix` provided at construction time).</param>
        /// <param name = "others">summary: other elements to be included in the array.</param>
