...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.DisappointingCollectionSource), fullyQualifiedName: "jsii-calc.compliance.DisappointingCollectionSource")]
    public class DisappointingCollectionSource : DeputyBase
    {
        ...
        = GetStaticProperty<string[]>(typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.DisappointingCollectionSource));
        ...
        = GetStaticProperty<System.Collections.Generic.IDictionary<string, double>>(typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.DisappointingCollectionSource));
    }
}
