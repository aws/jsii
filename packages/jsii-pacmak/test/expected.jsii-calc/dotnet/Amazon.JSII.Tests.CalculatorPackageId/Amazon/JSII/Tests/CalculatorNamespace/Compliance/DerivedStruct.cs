...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    public class DerivedStruct : Amazon.JSII.Tests.CalculatorNamespace.Compliance.IDerivedStruct
    {
        /// <remarks>
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        ...
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        [JsiiProperty(name: "nonPrimitive", typeJson: "{\"fqn\":\"jsii-calc.compliance.DoubleTrouble\"}", isOverride: true)]
