...
namespace Amazon.JSII.Tests.CalculatorNamespace
{
    ...
    public class AllowedMethodNames : DeputyBase
    {
        ...
        [JsiiMethod("getBar", null, "[{\"name\":\"_p1\",\"value\":{\"type\":{\"primitive\":\"string\"}}},{\"name\":\"_p2\",\"value\":{\"type\":{\"primitive\":\"number\"}}}]")]
        ...
        [JsiiMethod("getFoo", "{\"type\":{\"primitive\":\"string\"}}", "[{\"name\":\"withParam\",\"value\":{\"type\":{\"primitive\":\"string\"}}}]")]
        public virtual string GetFoo(string withParam)
        {
            return InvokeInstanceMethod<string>(new object[]{withParam});
        }

        [JsiiMethod("setBar", null, "[{\"name\":\"_x\",\"value\":{\"type\":{\"primitive\":\"string\"}}},{\"name\":\"_y\",\"value\":{\"type\":{\"primitive\":\"number\"}}},{\"name\":\"_z\",\"value\":{\"type\":{\"primitive\":\"boolean\"}}}]")]
        ...
        [JsiiMethod("setFoo", null, "[{\"name\":\"_x\",\"value\":{\"type\":{\"primitive\":\"string\"}}},{\"name\":\"_y\",\"value\":{\"type\":{\"primitive\":\"number\"}}}]")]
