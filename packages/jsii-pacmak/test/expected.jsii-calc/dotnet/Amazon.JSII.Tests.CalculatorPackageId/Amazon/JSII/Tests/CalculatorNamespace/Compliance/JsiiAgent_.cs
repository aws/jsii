...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    /// </remarks>
    [JsiiClass(nativeType: typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.JsiiAgent_), fullyQualifiedName: "jsii-calc.compliance.JsiiAgent")]
    public class JsiiAgent_ : DeputyBase
    {
        ...
        {
            get => GetStaticProperty<string?>(typeof(Amazon.JSII.Tests.CalculatorNamespace.Compliance.JsiiAgent_));
        }
    }
}
