...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "jsii-calc.compliance.RootStruct")]
    public class RootStruct : Amazon.JSII.Tests.CalculatorNamespace.Compliance.IRootStruct
    {
        ...
        /// </remarks>
        [JsiiOptional]
        [JsiiProperty(name: "nestedStruct", typeJson: "{\"fqn\":\"jsii-calc.compliance.NestedStruct\"}", isOptional: true, isOverride: true)]
