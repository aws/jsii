...
namespace Amazon.JSII.Tests.CalculatorNamespace.Compliance
{
    ...
    /// </remarks>
    [JsiiByValue(fqn: "jsii-calc.compliance.TopLevelStruct")]
    public class TopLevelStruct : Amazon.JSII.Tests.CalculatorNamespace.Compliance.ITopLevelStruct
    {
        ...
        /// <strong>Stability</strong>: Experimental
        /// </remarks>
        [JsiiProperty(name: "secondLevel", typeJson: "{\"union\":{\"types\":[{\"primitive\":\"number\"},{\"fqn\":\"jsii-calc.compliance.SecondLevelStruct\"}]}}", isOverride: true)]
