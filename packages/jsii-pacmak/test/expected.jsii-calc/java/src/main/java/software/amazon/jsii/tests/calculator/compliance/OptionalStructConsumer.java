...
@software.amazon.jsii.Jsii(module = software.amazon.jsii.tests.calculator.$Module.class, fqn = "jsii-calc.compliance.OptionalStructConsumer")
public class OptionalStructConsumer extends software.amazon.jsii.JsiiObject {
     ...
     */
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    public OptionalStructConsumer(final @org.jetbrains.annotations.Nullable software.amazon.jsii.tests.calculator.compliance.OptionalStruct optionalStruct) {
    ...
    /**
     * A fluent builder for {@link software.amazon.jsii.tests.calculator.compliance.OptionalStructConsumer}.
     */
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    public static final class Builder {
        ...
        private software.amazon.jsii.tests.calculator.compliance.OptionalStruct.Builder optionalStruct;
        ...
        /**
         * @returns a newly built instance of {@link software.amazon.jsii.tests.calculator.compliance.OptionalStructConsumer}.
         */
        @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        public software.amazon.jsii.tests.calculator.compliance.OptionalStructConsumer build() {
            return new software.amazon.jsii.tests.calculator.compliance.OptionalStructConsumer(
        ...
        private software.amazon.jsii.tests.calculator.compliance.OptionalStruct.Builder optionalStruct() {
            if (this.optionalStruct == null) {
                this.optionalStruct = new software.amazon.jsii.tests.calculator.compliance.OptionalStruct.Builder();
            }
