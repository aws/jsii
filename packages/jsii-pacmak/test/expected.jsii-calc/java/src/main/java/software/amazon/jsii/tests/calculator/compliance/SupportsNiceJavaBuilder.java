...
@software.amazon.jsii.Jsii(module = software.amazon.jsii.tests.calculator.$Module.class, fqn = "jsii-calc.compliance.SupportsNiceJavaBuilder")
public class SupportsNiceJavaBuilder extends software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilderWithRequiredProps {
    ...
    /**
     * A fluent builder for {@link software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilder}.
     */
    @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
    public static final class Builder {
        ...
        private software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilderProps.Builder props;
        ...
        /**
         * @returns a newly built instance of {@link software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilder}.
         */
        @software.amazon.jsii.Stability(software.amazon.jsii.Stability.Level.Experimental)
        public software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilder build() {
            return new software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilder(
                this.id,
                this.defaultBar,
        ...
        private software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilderProps.Builder props() {
            if (this.props == null) {
                this.props = new software.amazon.jsii.tests.calculator.compliance.SupportsNiceJavaBuilderProps.Builder();
            }
            return this.props;
        }
    }
