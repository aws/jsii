...
@org.jsii.Jsii(module = org.jsii.tests.calculator.$Module.class, fqn = "jsii$jsii_calc$.GiveMeStructs")
public class GiveMeStructs extends org.jsii.JsiiObject {
    ...
    public java.lang.Number readFirstNumber(final org.jsii.tests.calculator.lib.MyFirstStruct first) {
        return this.jsiiCall("readFirstNumber", java.lang.Number.class, java.util.stream.Stream.of(first).toArray());
    }
    /**
    ...
    public org.jsii.tests.calculator.DoubleTrouble readDerivedNonPrimitive(final org.jsii.tests.calculator.DerivedStruct derived) {
        return this.jsiiCall("readDerivedNonPrimitive", org.jsii.tests.calculator.DoubleTrouble.class, java.util.stream.Stream.of(derived).toArray());
    }
    /**
    ...
    public org.jsii.tests.calculator.lib.MyFirstStruct derivedToFirst(final org.jsii.tests.calculator.DerivedStruct derived) {
        return this.jsiiCall("derivedToFirst", org.jsii.tests.calculator.lib.MyFirstStruct.class, java.util.stream.Stream.of(derived).toArray());
    }
