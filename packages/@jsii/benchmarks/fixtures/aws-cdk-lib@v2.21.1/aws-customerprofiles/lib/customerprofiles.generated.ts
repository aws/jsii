...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:07.462Z","fingerprint":"nB8EMx4MH3JA52eXZHBtwWp4v8lazJ3XR7QrS6saCF4="}
...
export class CfnDomain extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnDomainProps) {
        ...
        this.attrLastUpdatedAt = cdk.Token.asString(this.getAtt('LastUpdatedAt'));
