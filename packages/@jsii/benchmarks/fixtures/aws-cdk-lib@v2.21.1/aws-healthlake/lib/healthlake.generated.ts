...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:08.630Z","fingerprint":"493SXxaZZoyWNEqDJWY5qPfNHu33IBOlb5cpvLYncyE="}
...
export class CfnFHIRDatastore extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnFHIRDatastoreProps) {
        ...
        this.attrDatastoreArn = cdk.Token.asString(this.getAtt('DatastoreArn'));
        this.attrDatastoreEndpoint = cdk.Token.asString(this.getAtt('DatastoreEndpoint'));
        this.attrDatastoreId = cdk.Token.asString(this.getAtt('DatastoreId'));
        this.attrDatastoreStatus = cdk.Token.asString(this.getAtt('DatastoreStatus'));
