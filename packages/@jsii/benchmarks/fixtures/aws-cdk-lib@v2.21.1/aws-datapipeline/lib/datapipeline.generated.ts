...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:07.516Z","fingerprint":"w+hJTs5gk3aaC1f2WcyOhCkSXm3xOR0i4R3st9yNjIo="}
...
function CfnPipelinePropsValidator(properties: any): cdk.ValidationResult {
    ...
    errors.collect(cdk.propertyValidator('parameterObjects', cdk.requiredValidator)(properties.parameterObjects));
...
function CfnPipelinePropsFromCloudFormation(properties: any): cfn_parse.FromCloudFormationResult<CfnPipelineProps> {
    ...
    ret.addPropertyResult('parameterObjects', 'ParameterObjects', cfn_parse.FromCloudFormation.getArray(CfnPipelineParameterObjectPropertyFromCloudFormation)(properties.ParameterObjects));
...
export class CfnPipeline extends cdk.CfnResource implements cdk.IInspectable {
     ...
     * @link http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-datapipeline-pipeline.html#cfn-datapipeline-pipeline-parameterobjects
     */
    public parameterObjects: Array<CfnPipeline.ParameterObjectProperty | cdk.IResolvable> | cdk.IResolvable;
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnPipelineProps) {
        ...
        cdk.requireProperty(props, 'parameterObjects', this);
