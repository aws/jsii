...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:09.290Z","fingerprint":"ORmicNM0RZfCs2vp57pp7DcOL/630KloUMQ+c9GcdQI="}
...
export class CfnFlow extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnFlowProps) {
        ...
        this.attrFlowAvailabilityZone = cdk.Token.asString(this.getAtt('FlowAvailabilityZone'));
        this.attrSourceIngestIp = cdk.Token.asString(this.getAtt('Source.IngestIp'));
        this.attrSourceSourceArn = cdk.Token.asString(this.getAtt('Source.SourceArn'));
        this.attrSourceSourceIngestPort = cdk.Token.asString(this.getAtt('Source.SourceIngestPort'));
...
export class CfnFlowEntitlement extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnFlowEntitlementProps) {
        ...
        this.attrEntitlementArn = cdk.Token.asString(this.getAtt('EntitlementArn'));
...
export class CfnFlowOutput extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnFlowOutputProps) {
        ...
        this.attrOutputArn = cdk.Token.asString(this.getAtt('OutputArn'));
...
export class CfnFlowSource extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnFlowSourceProps) {
        ...
        cdk.requireProperty(props, 'description', this);
        cdk.requireProperty(props, 'name', this);
        this.attrIngestIp = cdk.Token.asString(this.getAtt('IngestIp'));
        this.attrSourceArn = cdk.Token.asString(this.getAtt('SourceArn'));
        this.attrSourceIngestPort = cdk.Token.asString(this.getAtt('SourceIngestPort'));
