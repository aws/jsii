...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:08.399Z","fingerprint":"XNR/KvCsP9PboOOEbrwZHEM1KDIREFS/5tbRyYkamJo="}
...
export class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnEnvironmentProps) {
        ...
        this.attrDedicatedServiceAccountId = cdk.Token.asString(this.getAtt('DedicatedServiceAccountId'));
        this.attrEnvironmentArn = cdk.Token.asString(this.getAtt('EnvironmentArn'));
        this.attrEnvironmentId = cdk.Token.asString(this.getAtt('EnvironmentId'));
        this.attrEnvironmentUrl = cdk.Token.asString(this.getAtt('EnvironmentUrl'));
        this.attrSageMakerStudioDomainUrl = cdk.Token.asString(this.getAtt('SageMakerStudioDomainUrl'));
