...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:08.284Z","fingerprint":"QOqLiBsT1cm3S8lU4hlRrzMF5GBO4J1Wck/UHbJkQwc="}
...
export class CfnCluster extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnClusterProps) {
        ...
        this.attrMasterPublicDns = cdk.Token.asString(this.getAtt('MasterPublicDNS'));
