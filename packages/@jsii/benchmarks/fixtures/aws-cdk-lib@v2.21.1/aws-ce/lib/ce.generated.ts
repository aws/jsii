...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:06.969Z","fingerprint":"5DeznuFT7IRWPGxgGc7Oi65Qlv8WGTjmB3yTqo/8Kdw="}
...
export class CfnAnomalyMonitor extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnAnomalyMonitorProps) {
        ...
        this.attrDimensionalValueCount = cdk.Token.asNumber(this.getAtt('DimensionalValueCount'));
        this.attrLastEvaluatedDate = cdk.Token.asString(this.getAtt('LastEvaluatedDate'));
        this.attrLastUpdatedDate = cdk.Token.asString(this.getAtt('LastUpdatedDate'));
        this.attrMonitorArn = cdk.Token.asString(this.getAtt('MonitorArn'));
...
export class CfnAnomalySubscription extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnAnomalySubscriptionProps) {
        ...
        this.attrSubscriptionArn = cdk.Token.asString(this.getAtt('SubscriptionArn'));
...
export class CfnCostCategory extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnCostCategoryProps) {
        ...
        this.attrEffectiveStart = cdk.Token.asString(this.getAtt('EffectiveStart'));
