...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:07.562Z","fingerprint":"OAHCAOfrQhWEUckxmwqyeymtmn4wkPMFmZ0dHqnKcMM="}
...
export class CfnResourceCollection extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnResourceCollectionProps) {
        ...
        this.attrResourceCollectionType = cdk.Token.asString(this.getAtt('ResourceCollectionType'));
