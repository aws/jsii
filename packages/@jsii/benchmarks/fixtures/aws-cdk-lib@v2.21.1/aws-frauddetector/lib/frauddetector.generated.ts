...
// @cfn2ts:meta@ {"generated":"2022-04-30T00:15:08.424Z","fingerprint":"G89vIT73amXS3puOkpkMeykurUg84fSuUpLkZpLdufk="}
...
export class CfnDetector extends cdk.CfnResource implements cdk.IInspectable {
    ...
    constructor(scope: constructs.Construct, id: string, props: CfnDetectorProps) {
        ...
        this.attrDetectorVersionId = cdk.Token.asString(this.getAtt('DetectorVersionId'));
        this.attrEventTypeArn = cdk.Token.asString(this.getAtt('EventType.Arn'));
        this.attrEventTypeCreatedTime = cdk.Token.asString(this.getAtt('EventType.CreatedTime'));
        this.attrEventTypeLastUpdatedTime = cdk.Token.asString(this.getAtt('EventType.LastUpdatedTime'));
