...
module Jsii
  ...
  class Kernel
    ...
    def pending_object
      pending_object_stack.last
    end

    # @api private
    # @param instance [Jsii::Object] the instance whose `create_object` call is in flight.
    # @return [Array<Jsii::Object>] the updated per-thread stack.
    def push_pending_object(instance)
      pending_object_stack.push(instance)
    end

    # @api private
    # @return [Jsii::Object, nil] the previously-pending instance, or `nil` if the stack was empty.
