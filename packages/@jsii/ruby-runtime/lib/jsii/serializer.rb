...
module Jsii
  ...
  module Serializer
    ...
    # delegates to a `jsii_serialize` method if present, falls back to the
    # kernel's native-implementation serializer when the value carries a JSII
    # interface module, or returns the value unchanged otherwise.
    #
    # @api private
    # @param value [Object] the value to encode.
    # @return [Object] the wire form, or `value` unchanged when nothing applies.
